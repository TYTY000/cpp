...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/03 09:37:56 by TYTY000           #+#    #+#             */
/*   Updated: 2024/05/03 09:37:56 by TYTY000          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
template <typename ForwardIt> auto sum(ForwardIt first, ForwardIt last) {
  ...
  if (distance > 1024000) {
    ...
    value_type total_sum =
        std::accumulate(results.begin(), results.end(), value_type{});
    return total_sum;
  }
